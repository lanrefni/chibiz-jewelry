...
import bannerImg from "../images/bannerMen.jpg";

class MenProds extends Component {
  state = {
    data: {},
    prods: [],
    errors: {},
  ...
  async componentDidMount() {
    ...
    await this.setCartQtyFromLocalStorage();
  }
  ...
  render() {
    ...
    return (
      <>
        <PageHeader titleText="תכשיטי גברים" img={this.state.bannerImg} />
        <div className="container">
          <div className="row">
            <div className="col-12">
              <div className="row overflowVisible">
                <h2 className="mt-2 mr-3" style={{ fontSize: "1.5em" }}>
                  מיון לפי:
                </h2>
...
/* mapStateToProps = (state) => {
  return {
    cartQty: state.cartItems.length,
  };
}; */
